#
# Be sure to run `pod lib lint CustomPickerView.podspec' to ensure this is a
...
'This library will open a new page to select an element of your array object. Just import and turn on the accessory'
  ...
  s.source_files = 'CustomPickerView/Classes/**/*'
  s.swift_version = '5.0'
  s.platforms = {
      "ios": "13.0"
  }
  # s.resource_bundles = {
  #   'CustomPickerView' => ['CustomPickerView/Assets/*.png']
  # }
